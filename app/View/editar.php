...
<form action="?metodo=insert" method="post">
  <div class="form mr-3 ml-3 mt-3 mb-3 pt-3 pb-3">
      ...
      <div class="col-sm-10">
        <select name="intervalo_doacao">
          <?php foreach ($intervalos as $intervalo) { ?>
            <option <?php if ($doador->intervalo_doacao->id == $intervalo->id) {
                      echo "selected";
                    } ?> value="<?php echo $intervalo->id; ?>"><?php echo $intervalo->nome; ?></option>
          <?php } ?>
        </select>
      </div>
    </div>
      ...
      <div class="col-sm-10">
        <select name="forma_pagamento">
          <?php foreach ($formas as $forma) { ?>
            <option <?php if ($doador->forma_pagamento->id == $forma->id) {
                      echo "selected";
                    } ?> value="<?php echo $forma->id; ?>"><?php echo $forma->nome; ?></option>
          <?php } ?>
        </select>
      </div>
    </div>
